									...
									<c:forEach items="${pageInfo.list}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/permission/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">添加资源</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								总共${pageInfo.pages} 页，共${pageInfo.total} 条数据。 每页 <select class="form-control" id="changePageSize" onchange="changePageSize()">
									<option>--请选择条数--${pageInfo.size}</option>
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
